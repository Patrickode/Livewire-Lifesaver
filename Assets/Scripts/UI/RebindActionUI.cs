...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    /// Slightly retooled from Unity's RebindUI Sample.
    /// </summary>
    public class RebindActionUI : MonoBehaviour
    {
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent
            <RebindActionUI, string, string, string>
        { }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent
            <RebindActionUI, InputActionRebindingExtensions.RebindingOperation>
        { }
        ...
        private void UpdateActionLabel()
        {
            ...
            {
                var action = m_Action ? m_Action.action : null;
        ...
        public bool ResolveActionAndBinding(out InputAction action, out int bindingIndex)
        {
            ...
            action = m_Action ? m_Action.action : null;
            if (action == null)
                return false;
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                .OnCancel(
                    operation =>
                    {
                        ...
                        if (m_RebindOverlay) { m_RebindOverlay.SetActive(false); }
                        UpdateBindingDisplay();
                        CleanUp();
                    })
                .OnComplete(
            ...
            // Show the name of the part in the UI.
            var partName = default(string);
            if (action.bindings[bindingIndex].isPartOfComposite)
            {
                partName = $"Binding to '{action.bindings[bindingIndex].name}.'\n";
            }
            else
            {
                partName = $"Binding to '{action.name}.'\n";
            }
            ...
            // temporarily set the binding text label to a placeholder.
            if (m_RebindOverlay && m_RebindText && m_RebindStartEvent == null && m_BindingText != null)
                m_BindingText.text = "<Rebinding...>";
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            var actionAsset = actionMap?.asset != null ? actionMap.asset : obj as InputActionAsset;
